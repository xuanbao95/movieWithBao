...
import icon123 from "../../../src/images/img/exclamation.png";
...
class BuyTicket extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.FilmInfo) {

            if (nextProps.FilmInfo.maLichChieu) {
                console.log(nextProps.FilmInfo.maLichChieu);
                this.setState({
