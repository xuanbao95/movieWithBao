...
import Movie_2 from "./Movie_2"
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import Slider from "react-slick";
class ListMovie_2 extends Component {
    renderListMovie = () => {
        return this.props.listMovie.map((movie, index) => {
            return (
                <Movie_2 movie={movie} key={index} />
            )
        })
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ListMovie_2);